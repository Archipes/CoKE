...
def compute_z(
    ...
    target_ids = tok(request["target_new"]["str"], return_tensors="pt", add_special_tokens=False)["input_ids"].to("cuda")[0]
    ...
    # Set up an optimization over a latent vector that, when outpA  ut at the
